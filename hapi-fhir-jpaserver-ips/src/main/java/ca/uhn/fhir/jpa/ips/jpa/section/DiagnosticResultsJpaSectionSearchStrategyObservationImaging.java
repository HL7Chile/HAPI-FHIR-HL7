...
public class DiagnosticResultsJpaSectionSearchStrategyObservationImaging extends JpaSectionSearchStrategy<Observation> {
	...
	public void massageResourceSearch(
		...
		theSearchParameterMap.addInclude(Observation.INCLUDE_PART_OF);
	}
