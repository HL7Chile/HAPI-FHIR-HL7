...
//		return "http://hl7.org/fhir/uv/ips/StructureDefinition/Bundle-uv-ips";
		return "https://hl7chile.cl/fhir/ig/clips/StructureDefinition/Bundle-documento-ips-cl";
	}

	public String getCompositionProfile(){
		return "https://hl7chile.cl/fhir/ig/clips/StructureDefinition/Composition-cl-ips";
	}

	/* Cambiar según sea la url del servidor */

	public String getBaseUrl(){
		return "http://localhost:8180/fhir";
	}
	...
	public IBaseResource createAuthor() {
		...
		organization.getMeta().addProfile("https://hl7chile.cl/fhir/ig/clips/StructureDefinition/Organizacion-cl-ips");
		return organization;
	}

	@Override
	public String createTitle(IpsContext theContext) {
		return "Resumen de Paciente del "
